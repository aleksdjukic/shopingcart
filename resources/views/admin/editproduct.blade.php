                        ...
                        <!-- /.card-header -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('product_name', $product->product_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Enter product name']) }}
                                </div>
                                <div class="form-group">
                                    {{ Form::label('', 'Product Price', ['for' => 'product_price']) }}
                                    {{ Form::number('product_price', $product->product_price, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Enter product price']) }}
                                </div>
                                <div class="form-group">
