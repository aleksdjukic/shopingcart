<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('admin') }}" class="brand-link">
        <img src="{{ ('backend/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ ('backend/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                     alt="User Image">
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item has-treeview {{ request()->is('sliders') ? 'menu-open' : ''  }} {{ request()->is('addslider') ? 'menu-open' : ''  }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item {{ request()->is('addslider') ? 'active' : ''  }}">
